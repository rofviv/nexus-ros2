...
def generate_launch_description():
    ...
    # --- NAV2 (solo navegación, sin map_server ni amcl) ---
    nav2_bringup_dir = get_package_share_directory('nav2_bringup')
    #nav2_params_path = '/home/leyla/Desktop/nexus_ws/src/robot_description/config/nav2_params.yaml'
    ...
    # TF estático: frame nivelado del LIDAR (con pequeño delay)
    lidar_level_tf = Node(
        package='tf2_ros',
    ...
    scan_from_l1 = Node(
        ...
        parameters=[{
            'input_cloud': '/points',
            'scan_topic':  '/scan',
            'scan_frame':  'lidar3d_scan',   # Debe coincidir con slam_toolbox.yaml
            'use_sim_time': LaunchConfiguration('use_sim_time'),
            'tilt_deg': 90.0,
            'pitch_min_deg':  0.5,
            'pitch_max_deg': 22.0,
    ...
    return LaunchDescription([
        ...
        gui_arg, model_arg, rviz_arg, use_sim_time,
