...
options = {
  ...
  use_nav_sat = false,                   
  use_landmarks = false,                 
  num_laser_scans = 1,                   -- /*  1 /scan  */
  num_multi_echo_laser_scans = 0,
  num_subdivisions_per_laser_scan = 1, 

  num_point_clouds = 0,                  -- /* points */

  lookup_transform_timeout_sec = 0.2,    -- wait TF 

  submap_publish_period_sec = 0.3,       --  submapas
...
MAP_BUILDER.use_trajectory_builder_2d = true -- SLAM 2D 
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.1) -- filtra ruido 
